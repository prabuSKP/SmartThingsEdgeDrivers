...
**Driver:** `matter-energy` (`drivers/SmartThings/matter-energy`)
...
```bash
ls -l /home/test/EdgeClient/connectedhomeip/out/linux-x64-phase2-energy-simulator/chip-phase2-energy-simulator-app
```

If not, build it first:

```bash
cd /home/test/EdgeClient/connectedhomeip
...
[`connectedhomeip/docs/platforms/linux/phase2_virtual_energy_simulator.md`](../../connectedhomeip/docs/platforms/linux/phase2_virtual_energy_simulator.md)
...
Clear the KVS and restart (see Section 9 of the simulator doc for details).
...
Then verify `fingerprints.yml` includes the expected device type IDs.
...
| Document | Location |
|---|---|
| Phase 2 simulator build + run guide | [`connectedhomeip/docs/platforms/linux/phase2_virtual_energy_simulator.md`](../../connectedhomeip/docs/platforms/linux/phase2_virtual_energy_simulator.md) |
| Smoke test guide | [`connectedhomeip/docs/platforms/linux/phase2_energy_smoke_test_guide.md`](../../connectedhomeip/docs/platforms/linux/phase2_energy_smoke_test_guide.md) |
| Comprehensive test guide | [`connectedhomeip/docs/platforms/linux/phase2_energy_comprehensive_test_guide.md`](../../connectedhomeip/docs/platforms/linux/phase2_energy_comprehensive_test_guide.md) |
| Hub log reference | [`SmartThingsEdgeDrivers/docs/MATTER_ENERGY_DRIVER_LOG_REFERENCE.md`](./MATTER_ENERGY_DRIVER_LOG_REFERENCE.md) |
| Device type mapping | [`SmartThingsEdgeDrivers/docs/ELECTRICAL_DEVICE_TYPE_MAPPING.md`](./ELECTRICAL_DEVICE_TYPE_MAPPING.md) |
| Phase 2 driver verification | [`SmartThingsEdgeDrivers/docs/PHASE2_EDGE_DRIVER_VERIFICATION.md`](./PHASE2_EDGE_DRIVER_VERIFICATION.md) |
...
| File | Contents |
|---|---|
| `drivers/SmartThings/matter-energy/terminalEdgeDriverLogsJune9` | ST CLI `logcat --log-level debug` output, 404 lines, 14:22:47–14:25:24 IST |
| `connectedhomeip/terminalVirtualEnergylogsJune9` | Identical to above — same logcat session saved under a second name; no separate virtual simulator console was captured |
| `drivers/SmartThings/matter-energy/hub-agent.log` | Full hub-side driver log; device events confirmed at lines 51970–51981 matching terminal log |
| `drivers/SmartThings/matter-energy/Screenshot_20260609_142320_SmartThings.jpg` | SmartThings app device card screenshot taken at 14:23 IST (~1 min after commissioning) |
